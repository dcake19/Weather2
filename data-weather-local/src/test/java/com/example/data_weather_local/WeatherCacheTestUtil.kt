...
object WeatherCacheTestUtil {
    fun createWeatherEntity(placeId: String,timestamp: Int=0) = WeatherEntity(placeId,
        timestamp,500,16.93f,
        15.91f,0.26f,timestamp+3600*6,timestamp+3600*20,
        4.1f, 20,90,1016,93,"light rain")

    fun createHourlyForecastEntityList(placeId: String,timestamp: Int=0) = listOf(
    ...
    fun createDailyForecastEntityList(placeId: String,timestamp: Int=0) = listOf(
    ...
    fun createWeatherData(timestamp: Int=0,timestampHourlyStart: Int=0,timestampDailyStart: Int=0) = WeatherData(
        timestamp,500,16.93f,
        15.91f,0.26f,timestamp+3600*6,timestamp+3600*20,
        4.1f, 20,90,1016,93,"light rain",
        createHourlyForecastDataList(timestampHourlyStart),
        createDailyForecastDataList(timestampDailyStart))
    ...
    fun createDailyForecastDataList(timestamp: Int=0) = listOf(
        ...
        WeatherDailyForecastData(timestamp+3600*24*2,502,
            ...
            3.17f,30, 100,1011,77,"heavy intensity rain"))
}